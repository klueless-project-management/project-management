...
|**Instructions for this  assessment**|<p>This is a project based assessment and will be assessing you on your knowledge and performance of the unit.</p><p>This assessment is in six parts:</p><p>1. 1. Develop the project charter</p><p>2. 2. Prepare to gather data</p><p>3. 3. Interview key stakeholder</p><p>4. 4. Develop the business case.</p><p>5. 5. Prepare the project plan</p><p>6. 6. Obtain approval for project plan.</p><p>The assessment also contains:</p><p>- Assessment Checklists 1-4</p><p>- Observation Checklists 1-2</p><p>- Assessment Feedback.</p><p>**Check the Assessment instructions and the Observation Checklists to ensure that you’ve covered all the required tasks.**</p>|
...
|**Due date and time allowed**|<p>Indicative time to complete assessment:</p><p>- In class: 45 minutes</p><p>- Out of class: Five hours.</p>|
|**Assessment location**|<p>Parts 3 and 6 will be completed in the classroom.</p><p>All other parts may be completed both in and outside of the classroom.</p><p>You may access your referenced text, learning notes and other resources.</p>|
...
### **Scenario**
You are currently employed as a Project Manager with [*Red Opal Innovations*](https://share.tafensw.edu.au/share/items/73f2bb48-c457-4fe9-96cf-618ee5f5f2bc/0/?attachment.uuid=2bbeb148-09a8-4884-871c-c95138fe38bf) (ROI) (ROI_Scenario.pdf). Sally Smith and Shane Jackson, the owners of a new company WizBiz, have approached ROI to develop a system for their company.
...
Download and unzip the resource folder (Cl_ProjMgt_AE_Pro_SR1.zip) to access the documents referred to in this assessment.
...
1. Quality management plan, addressing a minimum of three controls that will be implemented to assure quality. This must include how the system testing will be managed.
1. Risk register.
